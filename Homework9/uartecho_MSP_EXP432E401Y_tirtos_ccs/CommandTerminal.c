...
void HelpParse() {
    ...
    if (SubStrPtr != NULL){
        if        (MatchSubString(SubStrPtr,    "-help" ) || MatchSubString(SubStrPtr,"help"    )){
            ...
            HelpScriptMsg();
        } else if (MatchSubString(SubStrPtr,       "-if") || MatchSubString(SubStrPtr,"if"      )){
            HelpIfMsg();
        } else if (MatchSubString(SubStrPtr,     "-uart") || MatchSubString(SubStrPtr,"uart"    )){
            HelpUARTMsg();
        } else {
            InvalidMsg();
        }
...
void InvalidMsg(){
    ...
    strcpy(MsgBuffer,  "Invalid Command: ");
